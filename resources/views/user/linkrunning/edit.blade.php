...
@endpush
@push('scripts')
    <script src="/js/user/linkfollow/index.js"></script>
...
@endpush
@section('content')
    <form action="{{ route('users.linkfollows.update', ['id' => $link->id]) }}" method="POST">
        <div class="card-body">
            <div class="row">
        ...
        <div class="card-footer">
            ...
            <a href="{{ route('users.linkfollows.index') }}" class="btn btn-success">Xem danh sách</a>
        </div>
        @csrf
    </form>
    <div class="row">
